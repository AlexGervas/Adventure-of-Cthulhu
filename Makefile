...
OBJECTS = build/menu.o build/Drawchtul.o build/cleaning.o build/gun.o  build/knight.o build/Peasant.o build/enemy3.o build/moveenemy.o build/inttostr.o build/cthulhu.o build/kek.o 
...
build/menu.o: src/menu.c src/graphics.h
...
build/kek.o: src/kek.c src/kek.h src/graphics.h
